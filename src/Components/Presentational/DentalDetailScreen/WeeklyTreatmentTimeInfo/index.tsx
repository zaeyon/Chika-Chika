...
const WeeklyTreatmentTimeInfo = ({todayIndex, treatmentTimeInfo}: Props) => {
    ...
    const monTreatStartTime = treatmentTimeInfo.weekday.mon.treatmentTime[0].slice(0, 5);
    const monTreatEndTime = treatmentTimeInfo.weekday.mon.treatmentTime[1].slice(0, 5);
    const monLunchStartTime = treatmentTimeInfo.weekday.mon.lunchTime[0].slice(0, 5);
    const monLunchEndTime = treatmentTimeInfo.weekday.mon.lunchTime[1].slice(0, 5);
    const isExistMonTreatTime = (treatmentTimeInfo.weekday.mon.treatmentTime[0] === "00:00:00") ? false : true;
    const isExistMonLunchTime = (treatmentTimeInfo.weekday.mon.lunchTime[0] === "00:00:00") ? false : true;

    const tusTreatStartTime = treatmentTimeInfo.weekday.tus.treatmentTime[0].slice(0, 5);
    const tusTreatEndTime = treatmentTimeInfo.weekday.tus.treatmentTime[1].slice(0, 5);
    const tusLunchStartTime = treatmentTimeInfo.weekday.tus.lunchTime[0].slice(0, 5);
    const tusLunchEndTime = treatmentTimeInfo.weekday.tus.lunchTime[1].slice(0, 5);
    const isExistTusTreatTime = (treatmentTimeInfo.weekday.tus.treatmentTime[0] === "00:00:00") ? false : true;
    const isExistTusLunchTime = (treatmentTimeInfo.weekday.tus.lunchTime[0] === "00:00:00") ? false : true;

    const wedTreatStartTime = treatmentTimeInfo.weekday.wed.treatmentTime[0].slice(0, 5);
    const wedTreatEndTime = treatmentTimeInfo.weekday.wed.treatmentTime[1].slice(0, 5);
    const wedLunchStartTime = treatmentTimeInfo.weekday.wed.lunchTime[0].slice(0, 5);
    const wedLunchEndTime = treatmentTimeInfo.weekday.wed.lunchTime[1].slice(0, 5);
    const isExistWedTreatTime = (treatmentTimeInfo.weekday.wed.treatmentTime[0] === "00:00:00") ? false : true;
    const isExistWedLunchTime = (treatmentTimeInfo.weekday.wed.lunchTime[0] === "00:00:00") ? false : true;

    const thuTreatStartTime = treatmentTimeInfo.weekday.thu.treatmentTime[0].slice(0, 5);
    const thuTreatEndTime = treatmentTimeInfo.weekday.thu.treatmentTime[1].slice(0, 5);
    const thuLunchStartTime = treatmentTimeInfo.weekday.thu.lunchTime[0].slice(0, 5);
    const thuLunchEndTime = treatmentTimeInfo.weekday.thu.lunchTime[1].slice(0, 5);
    const isExistThuTreatTime = (treatmentTimeInfo.weekday.thu.treatmentTime[0] === "00:00:00") ? false : true;
    const isExistThuLunchTime = (treatmentTimeInfo.weekday.thu.lunchTime[0] === "00:00:00") ? false : true;

    const friTreatStartTime = treatmentTimeInfo.weekday.fri.treatmentTime[0].slice(0, 5);
    const friTreatEndTime = treatmentTimeInfo.weekday.fri.treatmentTime[1].slice(0, 5);
    const friLunchStartTime = treatmentTimeInfo.weekday.fri.lunchTime[0].slice(0, 5);
    const friLunchEndTime = treatmentTimeInfo.weekday.fri.lunchTime[1].slice(0, 5);
    const isExistFriTreatTime = (treatmentTimeInfo.weekday.fri.treatmentTime[0] === "00:00:00") ? false : true;
    const isExistFriLunchTime = (treatmentTimeInfo.weekday.fri.lunchTime[0] === "00:00:00") ? false : true;

    const satTreatStartTime = treatmentTimeInfo.sat.sat.treatmentTime[0].slice(0, 5);
    const satTreatEndTime = treatmentTimeInfo.sat.sat.treatmentTime[1].slice(0, 5);
    ...
    const isExistSatTreatTime = (treatmentTimeInfo.sat.sat.treatmentTime[0] === "00:00:00") ? false : true;
    const isExistSatLunchTime = (treatmentTimeInfo.sat.sat.lunchTime[0] === "00:00:00") ? false : true;
    ...
    if(treatmentTimeInfo.sunAndHoliday.treatmentTime[0] !== null) {
        sunTreatStartTime = treatmentTimeInfo.sunAndHoliday.treatmentTime[0].slice(0, 5);
        sunTreatEndTime = treatmentTimeInfo.sunAndHoliday.treatmentTime[1].slice(0, 5);
        isExistSunTreatTime = (treatmentTimeInfo.sunAndHoliday.treatmentTime[0] === "null") ? false : true;
    } else {
    ...
    if(todayIndex === 0) {
        ...
        isExistTodayLunchTime = (treatmentTimeInfo.weekday.mon.lunchTime[0] === "00:00:00") ? false : true;
        ...
        isExistTodayTreatTime = isExistTusTreatTime;
        isExistTodayLunchTime = (treatmentTimeInfo.weekday.tus.lunchTime[0] === "00:00:00") ? false : true;
        ...
        isExistTodayLunchTime = (treatmentTimeInfo.weekday.wed.lunchTime[0] === "00:00:00") ? false : true;
        ...
        isExistTodayLunchTime = (treatmentTimeInfo.weekday.thu.lunchTime[0] === "00:00:00") ? false : true;
        ...
        isExistTodayLunchTime = (treatmentTimeInfo.weekday.fri.lunchTime[0] === "00:00:00") ? false : true;
        ...
        isExistTodayTreatTime = isExistFriTreatTime;
        isExistTodayLunchTime = (treatmentTimeInfo.sat.sat.lunchTime[0] === "00:00:00") ? false : true;
