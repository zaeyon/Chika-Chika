...
const ImageDateContainer1 = Styled.View`
padding: 4px 8px 4px 8px;
position: absolute;
top: 0;
left: 0;
background-color: #131F3C70;
align-items: center;
...
const ImageDateContainer2 = Styled.View`
padding: 4px 8px 4px 8px;
position: absolute;
top: 0;
left: 0;
...
const BracePreviewImages = ({sortedImageArray}: Props) => {

  const [remainCount, setRemainCount] = useState<number>(
    sortedImageArray.length - 6,
  );

  console.log("BracePreviewImages sortedImageArray", sortedImageArray);

  const getDisplayedImageDate = (imageDate: string) => {

      const imageDateArray = imageDate.split("-");
      const displayedImageDate = `${imageDateArray[0]}.${imageDateArray[1]}.${imageDateArray[2]}`;

      return displayedImageDate;
  }
      ...
      {sortedImageArray.length === 1 && (
        <OneUnitImageContainer>
          <ImageContainer>
            ...
            />
            {sortedImageArray[0].imgDate && (
            <ImageDateContainer1>
              <OrderTypeText>
                {getDisplayedImageDate(sortedImageArray[0].imgDate)}
              </OrderTypeText>
            </ImageDateContainer1>
            )}
          </ImageContainer>
        ...
        <TwoUnitImageContainer>
          <ImagesRowContainer>
            ...
            <ImageContainer>
              ...
              />
              {sortedImageArray[1].imgDate && (
              <ImageDateContainer2>
                <OrderTypeText>
                  {getDisplayedImageDate(sortedImageArray[1].imgDate)}
                </OrderTypeText>
              </ImageDateContainer2>
              )}
            </ImageContainer>
          ...
          <ImagesColumnContainer>
            ...
            <ImagesRowContainer>
              ...
              <ImageContainer>
                ...
                />
                {sortedImageArray[2].imgDate && (
                <ImageDateContainer2>
                  <OrderTypeText>
                    {getDisplayedImageDate(sortedImageArray[2].imgDate)}
                  </OrderTypeText>
                </ImageDateContainer2>
                )}
              </ImageContainer>
          ...
          <ImagesColumnContainer>
            ...
            <ImagesRowContainer>
              ...
              <ImageContainer>
                ...
                />
                {sortedImageArray[3].imgDate && (
                <ImageDateContainer2>
                  <OrderTypeText>
                    {getDisplayedImageDate(sortedImageArray[3].imgDate)}
                  </OrderTypeText>
                </ImageDateContainer2>
                )}
              </ImageContainer>
          ...
          <ImagesColumnContainer>
            ...
            <ImagesRowContainer>
              ...
              <ImageContainer>
                ...
                />
                {sortedImageArray[4].imgDate && (
                <ImageDateContainer2>
                  <OrderTypeText>
                    {getDisplayedImageDate(sortedImageArray[4].imgDate)}
                  </OrderTypeText>
                </ImageDateContainer2>
                )}
              </ImageContainer>
          ...
          <MoreImagesColumnContainer>
            ...
            <ImagesRowContainer>
              ...
              <ImageContainer>
                ...
                />
                {sortedImageArray[5].imgDate && (
                <ImageDateContainer2>
                  <OrderTypeText>
                    {getDisplayedImageDate(sortedImageArray[5].imgDate)}
                  </OrderTypeText>
                </ImageDateContainer2>
                )}
              </ImageContainer>
...
export default BracePreviewImages;
