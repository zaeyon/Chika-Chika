...
const ParagraphItem = ({item, index, clickInsertedImage, changeImageOrder, onPressAddImage, descripInputRef, onSubmitParaDescripInput, onChangeParaDescripInput, onFocusParaDescripInput}: Props) => {

  const locationY = useRef<number>();
