...
import {Animated, PanResponder, TouchableWithoutFeedback, FlatList, ScrollView, StyleSheet} from 'react-native';
...
const DentalListSidingUpPanel = ({navigation, route}: any) => {
    const [openDentalListPanel, setOpenDentalListPanel] = useState<boolean>(false)
