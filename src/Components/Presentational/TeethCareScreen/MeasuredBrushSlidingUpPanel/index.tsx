...
const MeasuredBrushSlidingUpPanel = ({navigation, route}: Props) => {
    ...
    return (
        ...
        draggableRange={{top: DeviceInfo.hasNotch() ? hp('55%') : hp('48%'), bottom: (hp('10.59%'))}}
        openPanel={openPanel}
        hidePanel={hidePanel}
        >
        <Container>
            ...
            <PanelHeaderContainer>
                    ...
                    <PanelHeaderTitleText style={{marginTop:5}}>{"내 칫솔 상태 확인하기"}</PanelHeaderTitleText>
            </PanelHeaderContainer>
            )}
            {isPanelOpen && (
            <Container>
            ...
            <PanelIntroContainer>
                ...
                <BrushDetritionLabelText>{"칫솔 마모정도"}</BrushDetritionLabelText>
                <InfoIcon
            ...
            <DetritionStepContainer style={styles.cardShadow}>
                <DetritionStepValueContainer>
                    <DetritionStepValueText><DetritionStepValueText style={{fontWeight:"700"}}>{"4"}</DetritionStepValueText>{" 단계"}</DetritionStepValueText>
                </DetritionStepValueContainer>
            ...
            <MeasuredResultRowContainer>
                ...
                <BrushLifespanImage/>
                <MeasuredValueText style={{marginTop: 11}}>{"칫솔수명"}</MeasuredValueText>
                <MeasuredDescripText style={{marginTop: 5}}>{"D-24"}</MeasuredDescripText>
                </BrushLifespanContainer>
                <HabitContainer style={styles.cardShadow}>
                    <BrushLifespanImage/>
                    <MeasuredValueText style={{marginTop: 11}}>{"칫솔질 습관"}</MeasuredValueText>
                    <MeasuredDescripText style={{marginTop: 5}}>{"이빨 잘 닦고 계신거죠?"}</MeasuredDescripText>
                </HabitContainer>
            </MeasuredResultRowContainer>
            </Container>
            )}
