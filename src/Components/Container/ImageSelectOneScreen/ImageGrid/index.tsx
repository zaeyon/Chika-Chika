...
// Local Component
import ImageItem from '~/Components/Container/ImageSelectOneScreen/ImageGrid/ImageItem';
...
const ImageGrid = ({
  ...
  const renderImage = useCallback(({item, index}) => {
    ...
    return (
      <ImageItem image={item.node.image} moveToFullImage={moveToFullImage} />
    );
  }, []);
